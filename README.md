...
最后更新：2026 年 9 月 20 日 · Last updated: 20 September 2026
...
日程提醒由**你的手机本地生成**，不经过服务器，也不需要联网。

### 删除你的数据

**应用内删除**：打开应用 → **装扮** → **账号** → **删除账号** → 确认。

点击后立即永久删除：账号、日历、全部日程、贴纸、好友关系、你创建的共享日历。删除后**无法恢复**。
...
That immediately and permanently deletes your account, calendars, all plans, stickers, friendships and the shared calendars you created. It **cannot be undone**.
